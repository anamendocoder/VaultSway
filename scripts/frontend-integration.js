 ...
 * This file demonstrates how to integrate Vaultsway with a web frontend
 */

// For React/Vue/Angular applications
export class VaultswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new VaultswayClient(provider, contractAddress);
